        ...
        <div className="relative container max-xl:px-4 max-w-[1170px] mx-auto lg:py-[180px] md:py-24 py-16">
                    ...
                    >
                        {featuredBlogs.map((blog, index) => (
                            <SwiperSlide key={blog.id || index}>
                                <div className="bg-gradient-to-b cursor-pointer from-sky/0 to-sky/100 p-[1px] rounded-[10px]">
                                    <div className="bg-black/90 text-white relative rounded-[10px]">
                                        ...
                                        <div className="px-3 pb-[39px] flex flex-col">
                                            <div className="flex gap-2 relative top-[10px]">
                                                <span className="border-sky border rounded-full whitespace-nowrap bg-black leading-custom-lg hover:bg-sky hover:text-black text-xs px-6 xl:px-[42px] h-[37px] flex items-center">
                                                    {blog.category}
                                                </span>
                                                <span className="text-white/70 bg-light-black font-normal text-sm border-white hover:bg-sky hover:text-black hover:border-sky whitespace-nowrap border h-[37px] flex items-center rounded-full xl:px-[41px] px-6 py-[9.5px]">
            ...
            {featuredBlogs.length > 0 && (
                <div className="hidden md:flex justify-between absolute top-1/2 left-0 right-0 transform -translate-y-1/2 px-4">
                    <button className="swiper-button-prev size-[60px] bg-sky border border-sky group rounded-full transition-all duration-300">
                        <Image src="/assets/images/svg/slider-left-arrow.svg" alt="slider-arrow" width={30} height={27} className="w-[30px] group-hover:invert invert-0 brightness-0" />
                    </button>
                    <button className="swiper-button-next size-[60px] bg-sky border border-sky group rounded-full transition-all duration-300">
